...
Далее был проведен анализ данных. Были подготовленны следующие модели DecisionTreeClassifier, RandomForest, LogisticRegression. Была выбрана лучшая модель по мере F1 и AUC-ROC. 
